  ...
  return (
    ...
    >
      <div className="flex items-center justify-center h-full">
        <h1 className="text-white lg:mr-[630px] lg:text-[80px]  md:text-[60px] sm:text-[40px] text-[28px] font-semibold tracking-normal leading-tight max-w-[90%] md:max-w-[600px]">
          {heroService.title}
        </h1>
      </div>
    </div>
